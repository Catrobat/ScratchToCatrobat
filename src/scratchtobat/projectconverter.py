...
class ProjectConverter(object):
    ...
    def create_structure(self):
        open(os.path.join(self.output_folder, ".nomedia"), 'w').close()        
        os.mkdir(self.image_out_dir)
    ...
    def extract_sb2(self):
        with zipfile.ZipFile(self.input_sb2, 'r') as myzip: 
    ...
    def convert(self):
        ...
        catrobat_writer = CatrobatWriter(json_dict, self.output_folder)
