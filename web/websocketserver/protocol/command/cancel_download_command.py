...
class CancelDownloadCommand(Command):
    ...
    def execute(self, ctxt, args):
        ...
        _logger.info("Removing client from download list if exists")
        remove_client_from_download_list_if_exists(ctxt.redis_connection, job_ID, client_ID)
        return None
